...
const KB = [
  ...
  { k: ['lab', 'session', 'workshop', 'masterclass', 'forum', 'upcoming', 'date'], q: 'Upcoming AI Labs', a: 'The AI Leadership Lab is a 2½‑hour applied session, in person or virtual (lunch included in person), from $100–$297. New dates are being finalized now — join the mission and we’ll email you the moment a seat opens. <a href="programs.html#labs">See the Labs page →</a>' },
