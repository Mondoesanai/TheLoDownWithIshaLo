...
const KB = [
  ...
  { k: ['lab', 'session', 'workshop', 'masterclass', 'forum', 'upcoming', 'date'], q: 'Upcoming AI Labs', a: 'The AI Leadership Lab is a two‑part virtual micro‑learning experience — $125 per part, two 2‑hour sessions three weeks apart. October dates: Part One Oct 6 or Oct 27, Part Two Oct 15 or Oct 29. There’s also a free virtual Executive AI Leadership Forum on Oct 7 and Oct 28 (12–1pm CST). <a href="programs.html#labs">See dates and register →</a>' },
